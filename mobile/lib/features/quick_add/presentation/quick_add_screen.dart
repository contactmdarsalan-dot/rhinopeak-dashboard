                ...
                items: [
                  for (final item in products)
                    DropdownMenuItem(
                      value: item.id,
                      child: Text(
                        '${trValue(ref, item.name)} - ${trQuantity(ref, item.stock, item.unit)}',
                      ),
                    ),
                ],
          ...
          children: [
            DropdownButtonFormField<String>(
              ...
              items: [
                DropdownMenuItem(
                  value: 'Marketing',
                  child: Text(tr(ref, 'marketing')),
                ),
                DropdownMenuItem(value: 'Rent', child: Text(tr(ref, 'rent'))),
                DropdownMenuItem(
                  value: 'Salary',
                  child: Text(tr(ref, 'salary')),
                ),
                DropdownMenuItem(
                  value: 'Transport',
                  child: Text(tr(ref, 'transport')),
                ),
                DropdownMenuItem(
                  value: 'Repair',
                  child: Text(tr(ref, 'repair')),
                ),
                DropdownMenuItem(
                  value: 'Utilities',
                  child: Text(tr(ref, 'utilities')),
                ),
              ],
              onChanged: (value) =>
            ...
            Row(
              children: [
                ...
                const SizedBox(width: 10),
                Expanded(
                  child: _NumberField(controller: _tax, label: tr(ref, 'tax')),
                ),
              ],
            ),
            const SizedBox(height: 14),
              ...
              Expanded(
                child: DropdownButtonFormField<String>(
                  ...
                  items: [
                    DropdownMenuItem(
                      value: 'Stock In',
                      child: Text(tr(ref, 'stockIn')),
                    ),
                    DropdownMenuItem(
                      value: 'Stock Out',
                      child: Text(tr(ref, 'stockOut')),
                    ),
                    DropdownMenuItem(
                      value: 'Correction',
